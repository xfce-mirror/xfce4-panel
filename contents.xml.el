  ...
  <Groups>
    ...
    <Group>
      <Popup>
        <Item>
          ...
          <Tooltip>Βρείτε και εκτελέσετε εφαρμογές</Tooltip>
          <Icon id="3"/>
        </Item>
        <Item>
          <Caption>Konqueror</Caption>
          <Command term="0" sn="0">konqueror</Command>
          <Tooltip>Διαχειριστής Αρχείων Konqueror</Tooltip>
          <Icon id="2"/>
        </Item>
        <Item>
          <Caption>Ναυτίλος</Caption>
          <Command term="0" sn="0">nautilus --no-desktop</Command>
          <Tooltip>Διαχειριστής Αρχείων Ναυτίλος</Tooltip>
          <Icon id="2"/>
        </Item>
      </Popup>
      <Control id="-2" popup="1">
        <Command term="0" sn="1">xffm</Command>
        <Tooltip>Διαχειριστής Αρχείων</Tooltip>
        <Icon id="2"/>
      </Control>
    </Group>
    <Group>
      ...
      <Control id="-2" popup="0">
        ...
        <Tooltip>Περιηγητής Ιστού Mozilla</Tooltip>
        <Icon id="7"/>
      </Control>
    </Group>
    <Group>
    ...
    <Group>
      ...
      <Control id="-2" popup="0">
        ...
        <Tooltip>Αναπαραγωγέας Μουσικής</Tooltip>
        <Icon id="6"/>
      </Control>
    </Group>
    <Group>
    ...
    <Group>
      <Popup>
        <Item>
          <Caption>Διαχειριστής Εκτυπώσεων</Caption>
          <Command term="0" sn="1">xfprint-manager</Command>
          <Tooltip>Διαχείριση Εκτυπώσεων</Tooltip>
          <Icon id="9"/>
        </Item>
      </Popup>
      <Control id="-2" popup="1">
        <Command term="0" sn="1">xfprint4</Command>
        <Tooltip>Σύρετε εδώ ένα αρχείο για να το εκτυπώσετε</Tooltip>
        <Icon id="9"/>
      </Control>
    </Group>
    <Group>
