                                    ...
                                    gboolean     force_external)
{
  ...
  if (G_LIKELY (module_name != NULL) && (
        PANEL_IS_X11_DISPLAY (gdk_display_get_default ()) || (
          /* Wayland-incompatible embedded plugins */
          g_strstr_len ("pager showdesktop systray tasklist windowmenu", -1, module_name) == NULL
          /* Wayland-incompatible non-embedded plugins */
          && g_strstr_len ("clipman", -1, module_name) == NULL
        )
      ))
    {
#ifndef NDEBUG
