 ...
 * from the Walyand compositor from their interface name. Beyond convenience, you
 * should use this instead of getting your own `wl_registry` from the compositor, as
 * it centralizes resource management (as the documentation says, resources attached
 * to a `wl_registry` are only released when the `wl_display` is disconnected).
 *
