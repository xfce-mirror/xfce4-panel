...
/* change buttons */
static void button_update_image(GtkWidget *button, int type)
{
    GdkPixbuf *pb = NULL;
...
static GtkWidget *create_systembutton(int type)
{
    GtkWidget *button;
...
static void systembuttons_change_type(t_systembuttons *sb, int n, int type)
{
    GtkWidget *button;
    GList *li;
...
/* options dialog */
static void checkbutton_changed(GtkToggleButton *tb, 
...
static void buttons_changed(GtkOptionMenu *om, t_systembuttons_dialog *sbd)
{
    int i;
...
static void systembuttons_revert_configuration(t_systembuttons_dialog *sbd)
{
    GtkOptionMenu *om;
