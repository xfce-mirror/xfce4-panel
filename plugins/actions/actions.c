...
actions_plugin_action_confirmation_time (gpointer data)
{
  ...
  if (timeout->time_left == 0)
  ...
  else
    {
      ...
      child_box = actions_plugin_gtk_container_get_nth_child (gtk_dialog_get_content_area (GTK_DIALOG (timeout->dialog)), 0);
      label_box = actions_plugin_gtk_container_get_nth_child (child_box, 1);
      secondary_label = actions_plugin_gtk_container_get_nth_child (label_box, 1);
