...
static void
xfce_clock_binary_algo_decimal (gulong    *table,
                                GDateTime *time,
                                gboolean   seconds,
                                gint       rows,
                                gint       cols)
...
static void
xfce_clock_binary_algo_sexagesimal (gulong    *table,
                                    GDateTime *time,
                                    gboolean   seconds,
                                    gint       rows,
                                    gint       cols)
...
static void
xfce_clock_binary_algo_binary_time (gulong    *table,
                                    GDateTime *time,
                                    gboolean   seconds)
{
  guint n;
                        ...
                        cairo_t   *cr)
{
  ...
  switch (binary->mode)
    {
    case MODE_DECIMAL:
      xfce_clock_binary_algo_decimal (&table, time, binary->show_seconds, rows, cols);
      break;
    case MODE_SEXAGESIMAL:
      xfce_clock_binary_algo_sexagesimal (&table, time, binary->show_seconds, rows, cols);
      break;
    case MODE_BINARY_TIME:
      xfce_clock_binary_algo_binary_time (&table, time, binary->show_seconds);
      break;
    }
