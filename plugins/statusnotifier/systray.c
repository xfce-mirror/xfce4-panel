...
/* define the plugin */
//XFCE_PANEL_DEFINE_PLUGIN (SnPlugin, systray_plugin,
...
static void
systray_plugin_init (SnPlugin *plugin)
{
  plugin->manager = NULL;
  ...
  gtk_box_pack_start (GTK_BOX (plugin->hvbox), plugin->systray_box, TRUE, TRUE, 0);
